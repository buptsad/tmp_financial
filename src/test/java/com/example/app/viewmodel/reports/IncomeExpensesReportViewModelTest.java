...
class IncomeExpensesReportViewModelTest {
    ...
    private IncomeExpensesReportViewModel viewModel;

    @BeforeEach
    void setUp() {
        financeData = new FinanceData();
        viewModel = new IncomeExpensesReportViewModel(financeData);
    }
    ...
    void testAddRemoveChangeListener() {
        ...
        IncomeExpensesReportViewModel.ChartDataChangeListener listener = () -> called.add(true);
