...
class TrendReportPanelTest {
    private TrendReportPanel panel;
    
    // Create a test implementation of TrendReportViewModel
    static class TestViewModel extends TrendReportViewModel {
    ...
    @BeforeEach
    void setUp() {
        panel = new TrendReportPanel(new TestViewModel());
    }
    ...
    @Test
    void testIntervalFunctions() {
        assertDoesNotThrow(() -> {
            panel.setInterval("Weekly");
            panel.refreshChart();
            
            panel.setInterval("Monthly");
            panel.refreshChart();
            
            panel.setInterval("Daily");
            panel.refreshChart();
        });
    }
